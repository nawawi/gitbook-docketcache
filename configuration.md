...
Set the maximum size of the cache file in bytes. Maximum accepted size is 10485760 \(10MB\).  
...
Set the maximum size of the cache file stored on disk. Minimum accepted size is 104857600. \(100MB\).  
